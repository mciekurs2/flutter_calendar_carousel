        ...
        children: <Widget>[
          CalendarHeader(
            ...
            onLeftButtonPressed: () {
              ...
              this._pageNum > 0
                  ? _setDate(page: this._pageNum - 1, animate: false)
                  : null;
            },
          ...
          Expanded(
            ...
            onPageChanged: (index) {
              this._setDate(page: index, animate: false);
            },
          ...
          child: Container(
            ...
            child: GridView.count(
              ...
              children: List.generate(totalItemCount,
                ...
                if (minDate != null &&
                    now.millisecondsSinceEpoch < minDate.millisecondsSinceEpoch)
                  isSelectable = false;
                else if (maxDate != null &&
                    now.millisecondsSinceEpoch > maxDate.millisecondsSinceEpoch)
                  isSelectable = false;
                return renderDay(
                    isSelectable,
                    index,
...
//            : DateTime.now();
  ...
  void _setDate({int page = -1, bool animate = true}) {
    if (page == -1) {
      setState(() {
        _setDatesAndWeeks();
      });
